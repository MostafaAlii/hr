...
Route::prefix('admin')->group(function () {
    Route::group(['middleware' => 'guest:admin'], function () {
        Route::get('login', [Auth\AdminAuthController::class, 'index'])->name('admin.login');
        Route::post('login/admin', [Auth\AdminAuthController::class, 'login'])->name('admin.post.login');
    });
    Route::post('logout', [Auth\AdminAuthController::class, 'logout'])->name('admin.logout')->middleware('auth:admin');
});
...
Route::prefix('employee')->group(function () {
    Route::group(['middleware' => 'guest:employee'], function () {
        Route::get('login', [Auth\EmployeeAuthController::class, 'index'])->name('employee.login');
        Route::post('login/employee', [Auth\EmployeeAuthController::class, 'login'])->name('employee.post.login');
    });
    Route::post('logout', [Auth\EmployeeAuthController::class, 'logout'])->name('employee.logout')->middleware('auth:employee');
});